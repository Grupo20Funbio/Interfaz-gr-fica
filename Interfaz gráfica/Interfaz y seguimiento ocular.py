...
keys_set_1 = {0: "Hola", 1: "Adios", 2: "Si", 3: "No", 4: "Baño",
              5: "Bien", 6: "Mal", 7: "Tengo frío", 8: "Tengo calor", 9: "Apagar la luz",
              10: "Encender la luz", 11: "Tengo hambre", 12: "Tengo sed", 13: "Te quiero", 14: "<"}
...
def draw_menu():
    ...
    cv2.line(keyboard, (int(cols/2) - int(th_lines/2), 0),(int(cols/2) - int(th_lines/2), rows),
             (51, 51, 51), th_lines)
    cv2.putText(keyboard, "Frases predeterminadas", (80, 300), font, 2, (250,250,250), 5)
    cv2.putText(keyboard, "Notas", (80 + int(cols/2), 300), font, 2, (250,250,250), 5)
